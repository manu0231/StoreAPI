...
const getAllProducts =async (req, res) => {
    ...
    let products = await result.populate({path:'reviews',select:'rating title comment -product'})
...
const getProduct =async (req, res) => {
    ...
    .populate({path:'reviews',select:'rating title comment product'})
...
const updateProduct =async (req, res) => {
    const { id: product_ID } = req.params
    const products = await Product.findOneAndUpdate({ _id: product_ID }, req.body,
...
const deleteProduct =async (req, res) => {
    ...
    if(!products){
        ...
        res.status(StatusCodes.OK).json({ msg: `Deleted product with id ${product_ID}` })
...
module.exports =
    { createProduct, getAllProducts, getProduct, updateProduct, deleteProduct,uploadfile }